...
let maxSugarValue = null;
let maxSugarSlider = document.querySelector("#max-sugar-slider");
let maxSugarSpan = document.querySelector(".included-filters-max-sugar");
let maxSugarSpan2 = document.querySelector(".filter-max-sugar-value");
